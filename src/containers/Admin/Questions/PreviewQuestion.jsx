                                    ...
                                    {question.options.map((optionText, index) => {
                                        ...
                                        return (
                                            <div 
                                                ...
                                                onClick={() => handleSelectAnswer(letter)} // Make the entire div clickable
                                                style={{ cursor: "pointer", display: "flex", alignItems: "center", gap: "10px", padding: "10px" }} // Optional styling
                                            >
                                                <input
                                                    ...
                                                    value={letter}
                                                    checked={isSelected}
                                                    onChange={(e) => e.stopPropagation()} // Prevents event bubbling when clicking the radio button
